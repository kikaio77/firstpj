...
<body>
	...
	<c:forEach begin="${minBlock}" end="${(total<maxBlock)?total:maxBlock}"
		step="1" var="i">
		<c:choose>
			<c:when test="${num == i}">
				<span>${i}</span>
	...
	<input type="text" name="text" id="text" value="${title}" />
	<%} else if (title!=null){ %>
	<select name="category" id="category">
	...
	<input type="text" name="text" id="text" value="${content}" />
